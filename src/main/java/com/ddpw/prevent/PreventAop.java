...
import com.ddpw.exception.BusinessException;
import com.ddpw.utils.IPUtils;
...
import static com.ddpw.utils.RedisConstants.ACCESS_LIMIT_IP_KEY;
import static com.ddpw.utils.RedisConstants.ACCESS_LIMIT_USER_KEY;
...
public class PreventAop {
     ...
     * 定义防刷切入点
     */
    @Pointcut("@annotation(com.ddpw.prevent.Prevent)")
     ...
     * 定义防止重复提交切入点
     */
    @Pointcut("@annotation(com.ddpw.prevent.RepeatSubmit)")
